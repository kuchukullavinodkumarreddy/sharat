...
<html lang="en">
	...
	?>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">succor &copy; </h3>
		<!--	<div class="logo">
				<a href="index.php"><img src="images/logo.png" width="200px"></a>
			</div>-->
			<br />
			<p style="font-size:20px;color:white">We Care!</p>
			<br />
		</div>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Succor Fam<span>Hello India</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">9876543210</p>
			</div>
			<div>
		...
		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About Succor</b></span>
				Succor is e-commerce trading platform for grains & grocerries...
			</p>
